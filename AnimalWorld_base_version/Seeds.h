...
class Seeds :public Plant
{
    ...
    //Plant();
public:
    Seeds(short life_energy = MAX_LIFE_ENERGY, wchar_t sex = L'M', short age = 0, short speed = 0, Being::StateT t = StateT::PLANT, unsigned short child_count = 0, unsigned short parential_investment = 0, Point cur_pos = { 0,0 }, string app = "seeds") : Plant(life_energy, sex, age, speed, t, child_count, parential_investment, cur_pos, app)
    {
