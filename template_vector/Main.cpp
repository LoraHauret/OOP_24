...
int main()
{
   ...
   bool isInserted = ar.Insert(0, 1);   
    ...
    Vector<unsigned int, int>* ar3 = ar.Clone();
    cout << "вектор 1: " << ar;
    cout << "вектор 3: " << *ar3;
    ...
    Vector<unsigned int, int> ar4(ar);
    cout << "вектор 1: " << ar;
    cout << "вектор 4: " << ar4;
    cout << "\nИзменение вектора 1  (popback)\n";
    ar.PopBack();
    ...
    Vector<unsigned int, int> ar5;
    Vector<unsigned int, int> ar6(ar5);
    cout << ar5;
    cout << ar6;
