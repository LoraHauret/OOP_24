...
public: 
    ...
    enum class ClassType :char { BASE = 0, PREDATOR, HERBIVORE, CHICKEN, PIG, COW, HORSE, ZEBRA, RABBIT, SQUIRREL, MOUSE, FOX, TIGER, CAT, PLANT, LEAVES, SEEDS, SUNFLOWER, SEEDING, NUT, CARROT   };
...
public:
    ...
    Being(const Being&);
    virtual ClassType GetClassType() { return ClassType::BASE; }
...
//map<string, Emodji> Being::pictures = { {"fox", Being::convertToSurrogate(0x1F98A) }
//};
