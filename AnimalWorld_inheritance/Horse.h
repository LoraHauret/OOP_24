...
class Horse : virtual public Herbivore
{
...
public:
    ...
    static int GetMaxLevelLife()
    {
	return MAX_LIFE_ENERGY;
    }

    static int GetMaxLevelSpeed()
    {
	return SPEED;
    }
